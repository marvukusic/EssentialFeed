...
final class ImageCommentsSnapshotTests: XCTestCase {
    ...
    func test_listWithContent() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone8(style: .dark, contentSize: .extraExtraExtraLarge)), named: "IMAGE_COMMENTS_extraExtraExtraLarge")
    }
    ...
    private func comments() -> [CellControler] {
        commentControllers().map { CellControler($0) }
    }
