...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve { retrievedResult in
            ...
            case let (.success(retrievedCachedFeed), .success(expectedCacheFeed)):
                XCTAssertEqual(expectedCacheFeed?.feed, retrievedCachedFeed?.feed, file: file, line: line)
                XCTAssertEqual(expectedCacheFeed?.timestamp, retrievedCachedFeed?.timestamp, file: file, line: line)
